var LcwFactory = function(){
    this.param = arguments;
    if(!(this instanceof  LcwFactory) ){
        return new LcwFactory();
    }
}
LcwFactory.prototype = {
    multiSelect: function(opts, callBack) {
        ...
        var opt = {
            ...
            btnWidth : (opts.btnWidth ? opts.btnWidth : 215),
            width: (opts.width ? opts.width : 215),
            arry: [],
            dropdownStatus:(opts.dropdownStatus ? opts.dropdownStatus : "none"),
        }
        ...
        var _setAttribute = {
            ...
            btnStyle: 'outline:none;background:#FFFFFF;border:0px solid #e6e6e6;height:30px;border-radius:6px;margin-left:5px;width:' + opt.btnWidth + 'px;padding:0px 10px',

            _dropdown_contentStyle: 'display:'+opt.dropdownStatus+';position:absolute;background-color:#FFFFFF;width:' + opt.width + 'px;overflow:auto;box-shadow:0px 8px 16px 0px rgba(0, 0, 0, 0.2);z-index: 5;margin-left:5px',
        ...
        document.getElementById(opts.id).textContent = "";
